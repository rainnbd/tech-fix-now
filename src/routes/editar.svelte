        ...
        {:else}
          <form on:submit|preventDefault={guardarCambios}>
            <div class="campo">
              ...
              <input type="text" id="nombre" bind:value={servicio.nombre} required />
            </div>
            ...
            <div class="campo">
              ...
              <textarea id="descripcion" bind:value={servicio.descripcion} required></textarea>
            </div>
            ...
            <div class="campo">
              ...
              <div class="fotos">
                {#each servicio.fotos as foto, i}
                  <div class="foto">
                    <img src={typeof foto === 'string' ? foto : URL.createObjectURL(foto)} alt="Foto del servicio" />
            ...
            <div class="campo">
              ...
              <select id="departamento" bind:value={servicio.departamento} on:change={() => actualizarCiudades(servicio.departamento)} required>
